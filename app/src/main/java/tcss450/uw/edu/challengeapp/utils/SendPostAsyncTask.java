...
public class SendPostAsyncTask extends AsyncTask<Void, String, String> {
    ...
    private Consumer<String> mDoInBackground;
    ...
    public static class Builder {
        ...
        private Consumer<String> onDoInBackground = x -> {};
         ...
         * @return
         */
        public Builder onDoInBackground(final Consumer<String> val) {
            onDoInBackground = val;
            return this;
        }
